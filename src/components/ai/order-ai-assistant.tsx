              ...
              {messages.length === 0 ? (
                <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                    ...
                    <button
                      onClick={() => setInput('評估此配方是否必須製粒才能灌裝？分析原料的流動性、黏性、結塊風險，判斷純粉劑混合後能否直接填充膠囊？（給個分數，100分為一定需要製粒，0分為完全不需要）')}
                    ...
                    >
                      ...
                      <p className="text-blue-600 dark:text-blue-300 text-sm">"評估此配方是否必須製粒才能灌裝？分析原料的流動性、黏性、結塊風險，判斷純粉劑混合後能否直接填充膠囊？（給個分數，100分為一定需要製粒，0分為完全不需要）"</p>
                    </button>
                    <button
