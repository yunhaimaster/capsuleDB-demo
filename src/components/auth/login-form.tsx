...
export function LoginForm({ onLogin }: LoginFormProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center animated-gradient-bg-subtle floating-particles dark:from-gray-900 dark:to-gray-800">
      <Card className="card-3d-hover glass-card-easy-health w-full max-w-md mx-4 shadow-xl">
