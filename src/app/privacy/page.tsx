    ...
    <div className="min-h-screen logo-bg-animation flex flex-col">
      ...
      <main className="flex-1 pt-28 sm:pt-24 px-4 sm:px-6 md:px-12 lg:px-20 space-y-10 floating-combined pb-16">
        <section className="text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/15 border border-blue-300/40 text-xs text-blue-700">
            <Shield className="h-4 w-4" />
            Easy Health 隱私政策
          </div>
          <h1 className="text-2xl sm:text-3xl font-semibold text-gray-800">保護您的資料，是我們的首要任務</h1>
          ...
          {sections.map((section) => (
            <Card key={section.title} className="liquid-glass-card liquid-glass-card-elevated">
              <CardHeader className="flex items-center gap-3">
                ...
                <CardTitle className="text-base text-gray-800">{section.title}</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <section className="grid gap-6 md:grid-cols-2">
          <Card className="liquid-glass-card liquid-glass-card-elevated">
            <CardHeader>
              <CardTitle className="text-lg text-gray-800">資料請求與聯絡方式</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 text-sm text-gray-600">
              ...
              <p className="text-xs text-gray-500">我們會於 7 個工作天內回覆您的請求，並提供適當協助。</p>
            </CardContent>
          </Card>

          <Card className="liquid-glass-card liquid-glass-card-elevated">
            <CardHeader>
              <CardTitle className="text-lg text-gray-800">政策更新</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 text-sm text-gray-600">
              <p>隱私政策將因應法律與服務需求定期更新。所有更新會即時於本頁公布，並顯示最新生效日期。</p>
              <div className="rounded-xl bg-blue-500/10 border border-blue-300/40 p-3 text-blue-700 text-sm">
                最新更新日期：2025年10月1日
              </div>
            </CardContent>
          </Card>
