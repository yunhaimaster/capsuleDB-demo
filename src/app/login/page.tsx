...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen animated-gradient-bg-visible relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-8 md:gap-12 items-center">
          <section className="space-y-6 text-center md:text-left">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm sm:text-sm text-gray-600 leading-relaxed max-w-md md:pr-10">
