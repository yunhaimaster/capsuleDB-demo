    ...
    <div className="min-h-screen logo-bg-animation flex flex-col">
      ...
      <main className="flex-1 pt-28 sm:pt-24 px-4 sm:px-6 md:px-12 lg:px-20 space-y-10 floating-combined pb-16">
        <section className="text-center space-y-4">
          ...
          <h1 className="text-2xl sm:text-3xl font-semibold text-gray-800">專業、透明的合作協議</h1>
        ...
        <section className="grid gap-6 md:grid-cols-2">
          <Card className="liquid-glass-card liquid-glass-card-elevated">
            <CardHeader>
              <CardTitle className="text-lg text-gray-800">使用者責任</CardTitle>
            </CardHeader>
          ...
          <Card className="liquid-glass-card liquid-glass-card-elevated">
            <CardHeader>
              <CardTitle className="text-lg text-gray-800">聯絡與協助</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 text-sm text-gray-600">
              ...
              <p className="text-xs text-gray-500">我們將於 5 個工作天內回覆，並提供協助。</p>
            </CardContent>
          </Card>
        </section>
      </main>
