          ...
          <Card className="liquid-glass-card liquid-glass-card-elevated mb-8">
            <div className="liquid-glass-content">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-800">設置說明</h2>
              </div>

              <div className="space-y-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-blue-800 mb-2">為什麼需要設置？</h3>
          ...
          <Card className="liquid-glass-card liquid-glass-card-elevated mb-8">
            <div className="liquid-glass-content">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-800">創建數據庫表</h2>
              </div>
              ...
              <div className="liquid-glass-content">
                ...
                <div className="space-y-3">
                  ...
                  {createResult.tables && createResult.tables.length > 0 && (
                    <div>
                      <h4 className="font-medium text-gray-800 mb-2">已創建的表：</h4>
